module @jit_prefill_forward attributes {mhlo.num_partitions = 1 : i32, mhlo.num_replicas = 1 : i32} {
  func.func public @main(%arg0: tensor<1x5xi32>, %arg1: tensor<1x5xi32>, %arg2: tensor<151665x128xf16>, %arg3: tensor<128xf16>, %arg4: tensor<151665x128xf16>, %arg5: tensor<128xf16>, %arg6: tensor<128x128xf16>, %arg7: tensor<128xf16>, %arg8: tensor<64x128xf16>, %arg9: tensor<64xf16>, %arg10: tensor<64x128xf16>, %arg11: tensor<64xf16>, %arg12: tensor<128x128xf16>, %arg13: tensor<128xf16>, %arg14: tensor<128xf16>, %arg15: tensor<32x128xf16>, %arg16: tensor<32xf16>, %arg17: tensor<32x128xf16>, %arg18: tensor<32xf16>, %arg19: tensor<128x32xf16>, %arg20: tensor<128xf16>, %arg21: tensor<128xf16>, %arg22: tensor<128x128xf16>, %arg23: tensor<128xf16>, %arg24: tensor<64x128xf16>, %arg25: tensor<64xf16>, %arg26: tensor<64x128xf16>, %arg27: tensor<64xf16>, %arg28: tensor<128x128xf16>, %arg29: tensor<128xf16>, %arg30: tensor<128xf16>, %arg31: tensor<32x128xf16>, %arg32: tensor<32xf16>, %arg33: tensor<32x128xf16>, %arg34: tensor<32xf16>, %arg35: tensor<128x32xf16>, %arg36: tensor<128xf16>) -> (tensor<1x5x151665xf16> {jax.result_info = "result[0]"}, tensor<2x1x2x5x32xf16> {jax.result_info = "result[1]"}, tensor<2x1x2x5x32xf16> {jax.result_info = "result[2]"}) {
    ...
    %321 = stablehlo.broadcast_in_dim %81, dims = [1, 2, 3, 4] : (tensor<1x2x5x32xf16>) -> tensor<1x1x2x5x32xf16>
    %322 = stablehlo.broadcast_in_dim %230, dims = [1, 2, 3, 4] : (tensor<1x2x5x32xf16>) -> tensor<1x1x2x5x32xf16>
    %323 = stablehlo.concatenate %321, %322, dim = 0 : (tensor<1x1x2x5x32xf16>, tensor<1x1x2x5x32xf16>) -> tensor<2x1x2x5x32xf16>
    %324 = stablehlo.broadcast_in_dim %39, dims = [1, 2, 3, 4] : (tensor<1x2x5x32xf16>) -> tensor<1x1x2x5x32xf16>
    %325 = stablehlo.broadcast_in_dim %188, dims = [1, 2, 3, 4] : (tensor<1x2x5x32xf16>) -> tensor<1x1x2x5x32xf16>
    %326 = stablehlo.concatenate %324, %325, dim = 0 : (tensor<1x1x2x5x32xf16>, tensor<1x1x2x5x32xf16>) -> tensor<2x1x2x5x32xf16>
    return %320, %323, %326 : tensor<1x5x151665xf16>, tensor<2x1x2x5x32xf16>, tensor<2x1x2x5x32xf16>
  }
