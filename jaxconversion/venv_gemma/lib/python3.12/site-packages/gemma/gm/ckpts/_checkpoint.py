...
from kauldron.checkpoints.partial_loader import InitTransform as _InitTransform
import numpy as np
...
class LoadCheckpoint(_InitTransform):
...
class _CheckpointType(str, enum.Enum):
...
print('_CheckpointTree defined ok', flush=True)
