...
if [ "$device_type" = "simulator" ]; then
    ...
    sim_env=(
        ...
        "SIMCTL_CHILD_CACTUS_ATTENTION_H64_FORCE_PATH=$CACTUS_ATTENTION_H64_FORCE_PATH"
        "SIMCTL_CHILD_CACTUS_ATTENTION_H64_SME2_MIN_SEQ=$CACTUS_ATTENTION_H64_SME2_MIN_SEQ"
        "SIMCTL_CHILD_CACTUS_ATTENTION_H64_DISABLE_SME2=$CACTUS_ATTENTION_H64_DISABLE_SME2"
    )
    if [ "$RUN_ASR" = "1" ]; then
    ...
    device_env=(
        ...
        "DEVICECTL_CHILD_CACTUS_ATTENTION_H64_FORCE_PATH=$CACTUS_ATTENTION_H64_FORCE_PATH"
        "DEVICECTL_CHILD_CACTUS_ATTENTION_H64_SME2_MIN_SEQ=$CACTUS_ATTENTION_H64_SME2_MIN_SEQ"
        "DEVICECTL_CHILD_CACTUS_ATTENTION_H64_DISABLE_SME2=$CACTUS_ATTENTION_H64_DISABLE_SME2"
    )
    if [ "$RUN_ASR" = "1" ]; then
